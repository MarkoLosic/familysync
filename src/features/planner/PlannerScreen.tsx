...
export function PlannerScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.colors.background }}>
      {/* Dekorativni krugovi */}
      <View style={{ position: 'absolute', top: 50, right: 20, width: 40, height: 40, borderRadius: 20, backgroundColor: theme.colors.primary, opacity: 0.4 }} />
        ...
        <View style={{ 
          ...
          <TouchableOpacity
            style={{
              ...
              backgroundColor: activeTab === 'calendar' ? theme.colors.primary : 'transparent',
            }}
            onPress={() => setActiveTab('calendar')}
          >
            <CalendarIcon size={18} color={activeTab === 'calendar' ? '#FFFFFF' : theme.colors.textSecondary} />
            <Text
              style={{
                marginLeft: 8,
                fontWeight: '600',
          ...
          >
            <CheckSquare size={18} color={activeTab === 'tasks' ? '#FFFFFF' : theme.colors.textSecondary} />
            <Text
              style={{
                marginLeft: 8,
                fontWeight: '600',
